    ...
    return (
        <main>
            <div className="max-w-screen-xl mx-auto px-4 flex items-center justify-start h-screen md:px-8">
                <div className="max-w-2x1 mx-auto text-gray-600">
                    <div className="space-y-3 text-center">
                        <h3 className="text-indigo-600 scroll-m-20 text-4xl font-extrabold md:text-[6rem] tracking-tight lg:text-5xl">
                            404 
                        </h3>
                    ...
                    <div className="mt-12">
                        <ul className="divide-y">
                            {
                                navigations.splice(0,1).map((item, idx) => (
